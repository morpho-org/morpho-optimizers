...
contract TestLens is TestSetup {
    ...
    function testUserHypotheticalBalanceStatesUnenteredMarket() public {
        ...
        assertEq(liquidityData.borrowableEth, collateral.percentMul(daiLtv), "maxDebt");
        assertEq(liquidityData.collateralEth, collateral, "collateral");
        assertEq(
    ...
    function testUserHypotheticalBalanceStatesAfterUnauthorisedBorrowWithdraw() public {
        ...
        assertEq(liquidityData.borrowableEth, 0, "liquidationThreshold");
        assertEq(liquidityData.maxDebtEth, 0, "maxDebt");
        assertEq(liquidityData.collateralEth, 0, "collateral");
        assertEq(
            liquidityData.debtEth,
