...
abstract contract RewardsLens is MarketsLens {
    ...
    function getUserUnclaimedRewards(address[] calldata _poolTokens, address _user)
        ...
        returns (uint256)
    {
        return rewardsLensLogic.getUserUnclaimedRewards(_poolTokens, _user);
    }
    ...
    function getAccruedSupplierComp(
        ...
        return rewardsLensLogic.getAccruedSupplierComp(_supplier, _poolToken, _balance);
    }
    ...
    function getAccruedSupplierComp(address _supplier, address _poolToken)
        ...
        returns (uint256)
    {
        return rewardsLensLogic.getAccruedSupplierComp(_supplier, _poolToken);
    }
    ...
    function getAccruedBorrowerComp(
        ...
        return rewardsLensLogic.getAccruedBorrowerComp(_borrower, _poolToken, _balance);
    }
    ...
    function getAccruedBorrowerComp(address _borrower, address _poolToken)
        ...
        returns (uint256)
    {
        return rewardsLensLogic.getAccruedBorrowerComp(_borrower, _poolToken);
    }
    ...
    function getCurrentCompSupplyIndex(address _poolToken) external view returns (uint256) {
        return rewardsLensLogic.getCurrentCompSupplyIndex(_poolToken);
    }
    ...
    function getCurrentCompBorrowIndex(address _poolToken) external view returns (uint256) {
        return rewardsLensLogic.getCurrentCompBorrowIndex(_poolToken);
    }
}
