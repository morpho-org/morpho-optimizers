...
contract TestLiquidateFuzzing is TestSetupFuzzing {
    ...
    function testLiquidate2Fuzzed(
        ...
        hevm.assume(suppliedAsset != borrowedAsset);
        ...
        customOracle.setDirectPrice(
            suppliedUnderlying,
            (oracle.getAssetPrice(suppliedUnderlying) * 90) / 100
        );
    ...
    function testLiquidate3Fuzzed(
        ...
        hevm.assume(vars.suppliedAsset != vars.borrowedAsset);
        ...
        customOracle.setDirectPrice(
            ...
            (oracle.getAssetPrice(vars.suppliedUnderlying) * 94) / 100
        );
