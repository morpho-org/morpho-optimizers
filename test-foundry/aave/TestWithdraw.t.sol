...
contract TestWithdraw is TestSetup {
    ...
    function testWithdraw3_2() public {
        ...
        uint256 p2pSupplyIndex = morpho.p2pSupplyIndex(aDai);
        uint256 expectedBorrowBalanceInP2P = underlyingToP2PUnit(borrowedAmount, p2pSupplyIndex);
    ...
    function testWithdrawUpdateIndexesSameAsCompound() public {
        ...
        supplier1.withdraw(cDai, collateral);
        ...
        supplier1.compoundWithdraw(cDai, collateral);
