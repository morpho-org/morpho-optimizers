...
contract TestPausableMarket is TestSetup {
    ...
    function testOnlyOwnerShouldTriggerPauseFunction() public {
        ...
        supplier1.setPauseStatus(cDai, true, true, true, true, true, true);

        morpho.setPauseStatus(cDai, true, true, true, true, true, true);
        (
            ,
            bool isSupplyPaused,
            bool isBorrowPaused,
    ...
    function testPauseUnpause() public {
        ...
        morpho.setPauseStatus(cDai, false, false, false, false, false, false);
        (
            ,
            isSupplyPaused,
            isBorrowPaused,
    ...
    function testShouldDisableSupply() public {
        ...
        morpho.setPauseStatus(cDai, true, false, false, false, false, false);
    ...
    function testShouldDisableBorrow() public {
        ...
        morpho.setPauseStatus(cDai, false, true, false, false, false, false);
    ...
    function testShouldDisableWithdraw() public {
        ...
        morpho.setPauseStatus(cDai, false, false, true, false, false, false);
    ...
    function testShouldDisableRepay() public {
        ...
        morpho.setPauseStatus(cDai, false, false, false, true, false, false);
    ...
    function testShouldDisableLiquidateOnCollateral() public {
        ...
        morpho.setPauseStatus(cDai, false, false, false, false, true, false);
    ...
    function testShouldDisableLiquidateOnBorrow() public {
        ...
        morpho.setPauseStatus(cDai, false, false, false, false, false, true);
