...
contract TestRepay is TestSetup {
    ...
    function testRepay2_1() public {
        ...
        assertApproxEqAbs(inP2PBorrower1, inP2PAvailableBorrower, 1, "available in P2P");
        assertApproxEqAbs(inP2PBorrower1, expectedBorrowBalanceInP2P, 1, "borrower in P2P 2");
