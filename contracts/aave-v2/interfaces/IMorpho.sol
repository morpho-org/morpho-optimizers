...
interface IMorpho {
    ...
    function userMarkets(address) external view returns (address[] memory);
    function supplyMarket(address, address) external view returns (bool);
    function borrowMarket(address, address) external view returns (bool);
