...
library Types {
    ...
    struct PoolIndexes {
        ...
        uint112 poolSupplyIndex; // Last pool supply index. Note: for the stETH the pool index is tweaked to take into account the staking rewards. Same for the borrow index.
