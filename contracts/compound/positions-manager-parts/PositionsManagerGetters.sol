...
contract PositionsManagerGetters is PositionsManagerStorage {
    ...
    function marketsManager() external view returns (IMarketsManager marketsManager_) {
        marketsManager_ = ps().marketsManager;
    }

    function rewardsManager() external view returns (IRewardsManager rewardsManager_) {
