...
library Errors {
    ...
    string public constant PM_DEBT_VALUE_ABOVE_MAX = "11";
    string public constant PM_BORROW_ON_COMP_FAIL = "12";
    string public constant PM_MINT_ON_COMP_FAIL = "13";
    string public constant PM_REDEEM_ON_COMP_FAIL = "14";
    string public constant PM_REPAY_ON_COMP_FAIL = "15";
    string public constant PM_ORACLE_FAIL = "16";
}
