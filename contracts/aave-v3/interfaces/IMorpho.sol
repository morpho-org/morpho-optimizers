...
interface IMorpho {
    ...
    function borrow(address _poolToken, uint256 _amount, address _receiver) external;
    function borrow(address _poolToken, uint256 _amount, uint256 _maxGasForMatching) external;
    function borrow(address _poolToken, uint256 _amount, address _receiver, uint256 _maxGasForMatching) external;
