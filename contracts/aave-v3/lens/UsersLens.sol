...
abstract contract UsersLens is IndexesLens {
    ...
    function computeLiquidationRepayAmount(
        ...
        (, , uint256 liquidationBonus, uint256 collateralReserveDecimals) = _getPoolParams(
            collateralToken
        );
    ...
    function getUserLiquidityDataForAsset(
        ...
        (assetData.ltv, assetData.liquidationThreshold, , assetData.decimals) = _getPoolParams(
            underlyingToken
        );
    ...
    /// @return lb The liquidation bonus.
    /// @return decimals The number of decimals.
    function _getPoolParams(address _underlying)
        internal
        view
        returns (
            uint256 ltv,
