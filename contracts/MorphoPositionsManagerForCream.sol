...
contract MorphoPositionsManagerForCream is ReentrancyGuard {
        ...
        returns (uint256 remainingToMatch)
    {
        ...
        // Withdraw from Cream
        _withdrawERC20FromCream(_crERC20Address, toWithdraw);
    }
        ...
        returns (uint256 remainingToUnmatch)
    {
        ...
        // Supply on Cream
        _supplyERC20ToCream(_crERC20Address, toSupply);
    }
        ...
        returns (uint256 remainingToUnmatch)
    {
        ...
        // Borrow on Cream
        require(crERC20Token.borrow(toBorrow) == 0, "_unmatchBorrowers:borrow-cream-fail");
    }
