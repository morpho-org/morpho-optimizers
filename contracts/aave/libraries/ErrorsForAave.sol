...
library Errors {
    ...
    string public constant PM_DELEGATECALL_BORROWER_UPDATE_NOT_SUCCESS = "12";
    string public constant PM_DELEGATECALL_SUPPLIER_UPDATE_NOT_SUCCESS = "13";
    string public constant PM_SUPPLY_ABOVE_CAP_VALUE = "14";
}
