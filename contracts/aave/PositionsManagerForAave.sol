...
contract PositionsManagerForAave is ReentrancyGuard {
        ...
        isAboveThreshold(_poolTokenAddress, _amount)
    {
        ...
        if (
            ...
            uint256 matched = matchingEngineForAave.matchBorrowers(
            ...
            if (matched > 0) {
                ...
                matchingEngineForAave.updateSuppliers(_poolTokenAddress, msg.sender);
            }
        ...
        isAboveThreshold(_poolTokenAddress, _amount)
    {
        ...
        if (
            ...
            uint256 matched = matchingEngineForAave.matchSuppliers(
                IAToken(_poolTokenAddress),
                underlyingToken,
                _amount
            ); // In underlying
            ...
            if (matched > 0) {
                ...
                matchingEngineForAave.updateBorrowers(_poolTokenAddress, msg.sender);
            }
    ...
    function _withdraw(
        ...
        if (supplyBalanceInOf[_poolTokenAddress][_supplier].onPool > 0) {
            ...
            matchingEngineForAave.updateSuppliers(_poolTokenAddress, _supplier);
