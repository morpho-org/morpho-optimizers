...
contract BorrowTest is TestSetup {
    // 2.1 - The borrower tries to borrow more than his collateral allows, the transaction reverts.
    ...
    // 2.6 - The NMAX biggest supplier don't match all of the borrowed amount, after NMAX match, the rest is borrowed and set onPool.
