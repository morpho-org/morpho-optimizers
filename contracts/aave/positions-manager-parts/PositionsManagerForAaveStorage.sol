...
abstract contract PositionsManagerForAaveStorage is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    MaxGas public MAX_GAS_FLOOR; // Minimum values settable for maxGas, immutable after initializing.
    MaxGas public MAX_GAS_CEILING; // Maximum values settable for maxGas, immutable after initializing.
    MaxGas public maxGas; // Max gas to consume within loops in matching engine functions.
    uint256 public NDS_FLOOR; // Minimal value settable for NDS, immutable after initializing.
    uint256 public NDS_CEILING; // Maximum value settable for NDS, immutable after initializing.
